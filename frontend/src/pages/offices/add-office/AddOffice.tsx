...
const AddOffice: React.FC<AddOfficeProps> = ({ isOpen, onAddClick, onCloseClick }) => {
  ...
  const [values, setValues] = useState<Office>(initialState);
  ...
  return (
    <div className={`add-office ${isOpen ? "active" : ""}`}>
      <div className="add-office__container">
        <div className="add-office__wrapper">
          <div className="add-office__header">
            <div className="add-office__title">Додавання нового ЦНАПу</div>
            <div>
              <div className="add-office__close" onClick={handleClose}></div>
            </div>
          </div>

          <div className="add-office__content">
          ...
          <div className="add-office__footer">
            <Button text="Додати" type="button" onClick={handleAddOffice} />
          </div>
        </div>
      </div>
